...
import (
	...
	"github.com/ONSdigital/dp-maps-api/service"
	"github.com/ONSdigital/dp-maps-api/service/mock"
	serviceMock "github.com/ONSdigital/dp-maps-api/service/mock"
	...
	Convey("Having a set of mocked dependencies", t, func() {
		...
		Convey("Given that all dependencies are successfully initialised", func() {
			...
			Convey("The checkers are registered and the healthcheck and http server started", func() {
				...
				So(initMock.DoGetHTTPServerCalls()[0].BindAddr, ShouldEqual, "localhost:27900")
